...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addAllMarkers() {
        ...
        //dorms
        insertMarker("בניין 106 - מעונות סודנטים על שם מוסקוביץ' - פרשין", "dorms", 32.065939, 34.84213, "מעונות סטודנטים, בחלק הדרומי של הקמפוס");
        ...
        insertMarker("בניין 1300 B - מעונות סודנטים", "dorms", 32.071051, 34.850034, "מעונות סטודנטים, החדשים ביותר בקמפוס. ניתן למצוא באיזור הבניין מסעדות, חנויות ועוד.");
        insertMarker("בניין 1300 A - מעונות סודנטים", "dorms", 32.072127, 34.850121, "מעונות סטודנטים, החדשים ביותר בקמפוס. ניתן למצוא באיזור הבניין מסעדות, חנויות ועוד.");
